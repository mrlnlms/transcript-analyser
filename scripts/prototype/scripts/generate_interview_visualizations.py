...
from prototype_experiments.interview_visualization import InterviewVisualizer


def main():
    transcript_path = ROOT / "data" / "sample" / "estatistica_psicobio_aula_2024.txt"
    output_dir = ROOT / "output" / "interview_visualizations"

    print("🚀 GERADOR DE VISUALIZAÇÕES DA ENTREVISTA")
    print("=" * 60)
    ...
    visualizer.generate_all_visualizations(results, output_dir=str(output_dir))
